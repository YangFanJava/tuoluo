...
import io.renren.common.validator.group.LocalGroup;
...
public class CloudStorageConfig implements Serializable {
    ...
    //本地绑定的域名
    @NotBlank(message="本地绑定的域名不能为空", groups = LocalGroup.class)
    @URL(message = "本地域名格式不正确", groups = LocalGroup.class)
